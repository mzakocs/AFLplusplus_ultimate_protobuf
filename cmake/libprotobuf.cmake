# Borrowed from https://github.com/google/libprotobuf-mutator/blob/master/cmake/external/protobuf.cmake
...
message(STATUS "Configuring libprotobuf...")
...
# create target to easily import and include into project
set(PROTOBUF_LIBRARY Protobuf)
add_library(${PROTOBUF_LIBRARY} INTERFACE)
...
set_property(TARGET ${PROTOBUF_LIBRARY} APPEND PROPERTY IMPORTED_CONFIGURATIONS NOCONFIG)